...
This should return a json response containing information about the added record. Adding the record should also trigger SQLTriggerFunction, which we will verify in the logs later.
